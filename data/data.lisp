...
(defprim remote (name schema url)
  ...
  (:components (*) nil)
  (:imports () (list (ng-import "@angular/http" 'http 'response)
                     (ng-import "rxjs/Rx" 'observable)
                     (ng-import "rxjs/add/operator/map")
                     (ng-import "rxjs/add/operator/catch")
                     (synth :imports schema)
                     ;; (ng-import (mkstr "./" (string-downcase (synth :name schema))) (synth :name schema))
                     ))
  (:dependencies () (list (ng-pair 'http (ng-type 'http) :private t))))
