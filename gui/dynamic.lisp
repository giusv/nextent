...
(defprim dynamic% (name element)
  (:pretty () (list 'dynamic (list :name name :element (synth :pretty element))))
  ...
  (:routes (father) 
           (list (ng-object :path (ng-const (string-downcase (mkstr ":" param)))
                            :component (ng-dynamic (mkstr father "-" name "-component"))
